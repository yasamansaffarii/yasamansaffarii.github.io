...
I am currently a Ph.D. candidate in Artificial Intelligence at [Kashan University](https://kashanu.ac.ir/en), supervised by [Dr. Salimi](https://scholar.google.co.uk/citations?hl=en&user=7ZCf1C8AAAAJ&view_op=list_works&sortby=pubdate). My doctoral research centers on **Task-Oriented Dialogue Systems** with a focus on **Reinforcement Learning (RL)**, specifically developing **topological and structural state representations** using **graph-based** and **attention-driven** methods. Recently, I have been working on a **Medical Dialogue System** that integrates **Large Language Models (LLMs)** with **Adapter-based fine-tuning**, using **Q-learning** to dynamically switch between sub-task behaviors such as diagnosis, inquiry, and recommendation. In parallel, I am exploring **probabilistic topological representations** in RL by combining **GMMs** with **graph learning**, to handle structural uncertainty and continuous topologies in decision-making.

Previously, I earned my Master’s degree in **Computer Art – Intelligent Simulator Design** from Tabriz Islamic Art University. My thesis focused on phonological modeling and **voice cloning** for dubbing education using deep learning. During this time, I also developed a **VR-based dance teaching application** using HTC VIVE and Neuron Mocap technologies, gaining practical experience in immersive learning environments and motion capture systems.

This diverse background reflects my long-standing interest in **interactive systems** that combine AI with human-centered design. I see the postdoctoral position at **Technische Universität Graz** as an opportunity to **fuse my doctoral expertise in graph-based decision-making with my Master's experience in embodied and multimodal interaction**. I believe such integration is crucial for developing intelligent interactive systems that are both grounded in data and responsive to user behavior.
