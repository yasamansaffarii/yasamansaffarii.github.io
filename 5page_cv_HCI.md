...
This diverse background reflects my long-standing interest in **interactive systems** that combine AI with human-centered design. I see the postdoctoral position at Graz as an opportunity to **fuse my doctoral expertise in graph-based decision-making with my Master's experience in embodied and multimodal interaction**. I believe such integration is crucial for developing intelligent interactive systems that are both grounded in data and responsive to user behavior.
